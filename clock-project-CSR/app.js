var main = function () {
            ...
            success: function (xml) {
                ...
                $items.each(function () {
                    ...
                    if (currentDateTime - lionAlertDate < 2160000) {
                        ...
                        $("#lionAlert").add("dfefef")
                        

                        // show the alert 
                        $("#lionAlert").fadeIn(1000).delay(10000).fadeOut();
                    }
    ...
    $.getJSON( "http://labs.bible.org/api/?passage=random&type=json&callback=?", function(data) {
        for(var i = 0; i < data.length; i++){
            var chapter = data[i].chapter;
            var book = data[i].bookname;
            var verse = data[i].verse;
        }
        $("#scripture").text(book + " " + chapter +":"+ verse);
    });
 ...
 setInterval(function getWeather(){
        $.ajax({
            ...
            success: function (data) {
                ...
                var skycons = new Skycons({"color": "#373d3f"});
